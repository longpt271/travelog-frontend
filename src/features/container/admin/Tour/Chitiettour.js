                ...
                <div className="ct">
                    {loading ? <div className="spin"><Spin className="mt-5" /></div> :
                        <div>
                            ...
                            <p>Avatar:<br /><img width="350px" height="400px" src={tour.avatar} alt="" /></p>
                            <p>Trailer:</p>
                            <div className="text-center mb-3" style={{width: 550}}>
                            ...
                            <div className="text-center mb-3">
                                {tour.Anhs.map(oki => (
                                    <img src={oki.link} width="500px" height="400px" className=" mb-2 mr-2 ml-2" alt="" />
                                                            ))}
                            </div>
                            <p>Bản đồ:&emsp; </p>
