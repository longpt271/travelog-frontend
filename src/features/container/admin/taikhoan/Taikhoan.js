...
import avatarUser from "../../../images/user-default.png";
                    ...
                    <Table columns={columns} dataSource={users.map((ok, index) => (
                        {
                            ...
                            avatar: ok.avatar ? <Image width="120px" height="120px" src={ok.avatar} alt="" /> : <Image width="120px" height="120px" src={avatarUser} alt="" />,
