...
const logoAbout = (
    <Menu>
        <Menu.Item key="0">
          <Linkrt to="/co-cau-to-chuc">Về chúng tôi</Linkrt>
        </Menu.Item>
    </Menu>
)
  const menuAvatar = (
  ...
  return (
    <div id="menu">
      ...
      <nav className="navbar navbar-expand-sm navbar-dark bg-dark fixed-top">
        <div className="d-flex flex-betw" style={{ justifyContent: 'center', alignItems: 'center'}}>
          <div>
              <Dropdown overlay={logoAbout} trigger={['hover']}>
          ...
          <div className="search-menu">
            <div className="row">
              ...
              <div className="col-6">
                <Search placeholder="Tìm kiếm tour" className="nav-link search-bar-menu" enterButton size="large"  />
                <Linkrt to="/list-tour">
                  <buton className="btn-search-menu">
                    {/* Nút này đè lên nút enter search của thẻ search */}
                  </buton>
                </Linkrt>
          ...
          <div className="collapse navbar-collapse" id="collapsibleNavId">
            <ul className="navbar-nav ml-auto" style={{ justifyContent: 'center', alignItems: 'center'}}>
              ...
              <li className="nav-item mr-3">
                <Dropdown overlay={menuAvatar} trigger={['hover']}>
                  <span className="nav-link" >
                    <Avatar size="large" style={{ border: "2px solid #0abf54", cursor: "pointer" }} src={
                      user ?
                        avatar ?
                          avatar :
