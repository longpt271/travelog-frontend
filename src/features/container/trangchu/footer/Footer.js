    ...
    <div id="footer">
      <footer className="page-footer font-small blue pt-4 container">
        <div className="container-fluid text-center text-md-left">
          <div className="row">
            {footer.map(ok => (
              <div className="col-md-3 mt-md-0 mt-3" key={ok.id}>
                {/* <h5 className="text-danger">Slogan</h5>
                <p>{ok.content}</p> */}
                <h5 className="text-danger">Liên hệ</h5>
                <p>
                  <strong>Email: </strong>
                  <i>{ok.email}</i>
                </p>
            ...
            <div className="col-md-3 mb-md-0 mb-3 mxh">
              <h5 className="text-danger ">Mạng xã hội</h5>
              {mxh.map(ok => (
        ...
        <div className="footer-copyright text-center py-3">
          © 2022 -
          <Link to="#"> Công ty tour du lịch Travelog.</Link>
        </div>
      </footer>
    </div >
